...
class CustomMenu extends Component {
    ...
    onDragEnd = result => {
        ...
        const _items = this.reorder(this.state.dragItems, result.source.index, result.destination.index)
                                ...
                                <Draggable key={item.title} draggableId={item.title} index={index}>
                                    {(provided, snapshot) => (
                                        <div
                                            ...
                                            onDragStart={e =>
                                                provided.dragHandleProps && provided.dragHandleProps.onDragStart(e)
                                            }>
                                            <Menu
                                                mode='inline'
                                                theme='dark'
